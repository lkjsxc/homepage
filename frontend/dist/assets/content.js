...
exports.portfolioContent = void 0;
exports.portfolioContent = {
    profile: {
        name: "Luca K.",
        headline: "Full-stack engineer focused on reliable product delivery",
        summary: "I design and ship web systems with clear architecture, strong observability, and pragmatic developer experience.",
        location: "Remote · CET",
    },
    featuredProjects: [
        {
            ...
            description: "Event-driven orchestration service for multi-step business automation with audit-safe execution trails.",
        ...
        },
        {
            ...
            description: "Contract-first REST platform with generated SDKs and CI policy checks to keep teams aligned.",
        ...
        },
        {
            ...
            description: "Operational analytics dashboard for inventory and conversion trends with near real-time refresh.",
        ...
        },
        {
            ...
            description: "Policy and reporting toolkit that flags cost drift across cloud environments before budgets are impacted.",
        ...
        },
        {
            ...
            description: "This Rust + TypeScript service, evolving from async jobs toward a content-driven portfolio experience.",
